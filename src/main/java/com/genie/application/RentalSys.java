...
//
//
//    public static void Register(model.Account account) throws IOException {
...
//    }
//
//    public static void addRental(model.Account account, HashSet<model.items> listofrental){
//        account.setListofrental(listofrental);
//    }
//
//    public static void removeRental(model.Account account, model.items rentalItem){
