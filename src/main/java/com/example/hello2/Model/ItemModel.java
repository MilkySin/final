...
public class ItemModel {
    ...
    public String getDescription() {
        return switch (title) {
            ...
            case "Sonic" ->
                    "\"Sonic\" is an action-adventure film based on the popular video game franchise. The story follows Sonic, a speedy blue hedgehog with incredible powers, as he teams up with a human friend named Tom to save the world from the evil Dr. Robotnik. Filled with humor, excitement, and thrilling chase sequences, \"Sonic\" brings the beloved video game character to life in a fun and entertaining way. Join Sonic on his high-speed adventure and get ready for a fast-paced and adrenaline-pumping experience!";
